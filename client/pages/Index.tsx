...
const features = [
  {
    ...
    title: "MCQ Practice",
    description:
      "Thousands of MCQs organized by year and subject covering all 4 years of BTech",
    link: "/mcqs",
    color: "text-blue-600",
    bgColor: "bg-blue-50",
  ...
  },
  {
    ...
    description:
      "Downloadable PDF textbooks categorized by year and subject for easy access",
    link: "/textbooks",
  ...
  },
  {
    ...
    description:
      "Well-structured past exam papers with easy search functionality",
    link: "/papers",
  ...
  },
  {
    ...
    description:
      "Curated YouTube videos for each subject with organized content structure",
    link: "/videos",
    color: "text-red-600",
    bgColor: "bg-red-50",
    stats: "1000+ Videos",
  },
  {
    ...
    description:
      "Handpicked learning resources, free tools, and skill enhancement content",
    link: "/skills",
  ...
  },
  {
    ...
    title: "Internships",
    description:
      "Current internship opportunities with application guidance and tips",
    link: "/internships",
  ...
  },
  {
    ...
    description:
      "Professional templates and tools to create stunning portfolios and ATS-friendly resumes",
    link: "/portfolio",
    color: "text-teal-600",
    bgColor: "bg-teal-50",
    stats: "20+ Templates",
...
const communityFeatures = [
  {
    ...
    title: "Live Chat",
    description:
      "Real-time chat with fellow students for instant help and discussions",
    link: "/chat",
  },
  {
    icon: Users,
    title: "Study Groups",
    description:
      "College-based groups for focused discussions and collaborative learning",
    link: "/community",
  },
  {
    icon: Star,
    title: "Freelancing",
    description:
      "Connect with admin for freelance opportunities and project work",
    link: "/freelancing",
  },
];
...
export default function Index() {
  ...
  const scrollToStudyMaterials = () => {
    const studyMaterialsSection = document.getElementById(
    ...
    <Layout>
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-primary/10 via-background to-accent/10">
        ...
        <div className="container mx-auto px-4 py-20 relative">
          <div
            className={`max-w-4xl mx-auto text-center transition-all duration-1000 ${isLoaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}
          >
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto leading-relaxed">
              Access comprehensive study materials, practice MCQs, connect with
              peers, and accelerate your engineering journey with our modern
              learning platform.
            </p>
      ...
      <section id="study-materials-section" className="py-20 bg-background">
      ...
      <section className="py-20 bg-muted/50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Connect, collaborate, and grow with thousands of engineering
              students
            </p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-br from-purple-50 to-indigo-100 dark:from-slate-800 dark:to-slate-900">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Refresh your mind and enhance cognitive skills with
              brain-stimulating games designed for students
            </p>
          </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                  <div className="text-center md:text-left">
                    ...
                    <p className="text-muted-foreground mb-6 leading-relaxed">
                      Challenge yourself with strategic games like Chess, solve
                      puzzles, and take productive breaks that actually enhance
                      your cognitive abilities and problem-solving skills.
                    </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-xl text-muted-foreground mb-8">
                Built by engineers, for engineers. We understand your journey
                and provide exactly what you need to succeed.
              </p>
                ...
                <div className="flex items-center space-x-3 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-blue-100">
                      Across 100+ Engineering Colleges
                    </p>
                  </div>
                </div>
      ...
      <section className="py-20 bg-gradient-education text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
            Join thousands of successful engineering students who've accelerated
            their learning with BTech Study Hub.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button
              size="lg"
              variant="outline"
              className="border-white text-white hover:bg-white hover:text-primary bg-white/10 backdrop-blur"
              asChild
            >
              <Link to="/contact">
