...
interface StudyGroup {
  ...
  maxMembers: number;
  avatar: string;
  category: 'Academic' | 'Project' | 'Competitive Programming' | 'Placement Prep';
  tags: string[];
  lastActivity: string;
  isPrivate: boolean;
  admin: string;
...
interface GroupLink {
  ...
  description: string;
  url: string;
  type: 'WhatsApp' | 'Telegram' | 'Discord' | 'Slack' | 'Study Material' | 'YouTube' | 'Website';
  members?: number;
  category: string;
  featured: boolean;
}
...
const mockStudyGroups: StudyGroup[] = [
  {
    ...
    description: 'Collaborative learning group for Data Structures and Algorithms. Daily practice sessions and doubt clearing.',
    college: 'IIT Delhi',
  ...
  },
  {
    ...
    description: 'Learn full-stack web development with MERN stack. Weekly projects and code reviews.',
    college: 'NIT Trichy',
  ...
  },
  {
    ...
    description: 'Daily contests, problem discussions, and interview preparation. From beginner to advanced level.',
    college: 'BITS Pilani',
  ...
  },
  {
    ...
    description: 'Mock interviews, resume reviews, and company-specific preparation. Success stories and tips sharing.',
    college: 'VIT Vellore',
  ...
  },
  {
    ...
    description: 'Weekly paper discussions, project collaborations, and hands-on ML implementations.',
    college: 'IIT Bombay',
...
const mockGroupLinks: GroupLink[] = [
  {
    ...
    description: 'Main WhatsApp group for all Computer Science students across different years',
  ...
  },
  {
    ...
    description: 'Discord server for coding interview preparation with daily challenges',
  ...
  },
  {
    ...
    description: 'Telegram channel with curated free programming courses and tutorials',
  ...
  },
  {
    ...
    description: 'Collaboration space for web development projects and code reviews',
  ...
  },
  {
    ...
    description: 'YouTube playlist with comprehensive Data Structures and Algorithms tutorials',
  ...
  },
  {
    ...
    description: 'Repository of textbooks, notes, and study materials for all branches',
...
const categories = ['All', 'Academic', 'Project', 'Competitive Programming', 'Placement Prep'];
const linkCategories = ['All', 'General', 'Interview Prep', 'Learning Resources', 'Project Collaboration', 'Study Resources'];
...
export default function Community() {
  ...
  const [filteredGroups, setFilteredGroups] = useState<StudyGroup[]>(mockStudyGroups);
  const [filteredLinks, setFilteredLinks] = useState<GroupLink[]>(mockGroupLinks);
  ...
  useEffect(() => {
    let filtered = groupLinks.filter(link => {
      ...
      const matchesCategory = selectedLinkCategory === 'All' || link.category === selectedLinkCategory;
      return matchesSearch && matchesCategory;
    });
  ...
  const getCategoryIcon = (category: StudyGroup['category']) => {
    switch (category) {
      ...
      case 'Competitive Programming': return <TrendingUp className="w-4 h-4" />;
      case 'Placement Prep': return <Award className="w-4 h-4" />;
  ...
  const getLinkIcon = (type: GroupLink['type']) => {
    switch (type) {
      ...
      case 'Discord': return <MessageCircle className="w-4 h-4 text-indigo-600" />;
      case 'Slack': return <MessageCircle className="w-4 h-4 text-purple-600" />;
      case 'YouTube': return <Video className="w-4 h-4 text-red-600" />;
      case 'Study Material': return <FileText className="w-4 h-4 text-orange-600" />;
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
                Join collaborative study groups, connect with peers, and access curated learning resources to enhance your academic journey.
              </p>
              ...
              <div className="flex flex-wrap items-center justify-between gap-4">
                <div className="flex flex-wrap gap-2">
                  {categories.map((category) => (
                    ...
                    >
                      {category !== 'All' && getCategoryIcon(category as StudyGroup['category'])}
                      <span>{category}</span>
                    </Button>
                  ))}
                </div>
                ...
                <Dialog open={showCreateGroup} onOpenChange={setShowCreateGroup}>
                  ...
                  <DialogContent>
                    <DialogHeader>
                      ...
                      <DialogDescription>
                        Start a new study group and invite your peers to collaborate.
                      </DialogDescription>
                    </DialogHeader>
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div>
                          ...
                          <Input
                            ...
                            onChange={(e) => setNewGroupData({...newGroupData, college: e.target.value})}
                            className="mt-1"
                          />
                        </div>
                        <div>
                  ...
                  <Card key={group.id} className="group hover:shadow-lg transition-all duration-300">
                      ...
                      <div className="flex items-start justify-between">
                        <div className="flex items-center space-x-3">
                          ...
                          <div className="flex-1">
                            ...
                            <p className="text-sm text-muted-foreground">{group.college}</p>
                          </div>
                        </div>
                        {group.isPrivate && (
                    ...
                    <CardContent className="space-y-4">
                      ...
                      <div className="flex items-center justify-between text-sm">
                        ...
                        <span className="text-muted-foreground">Admin: {group.admin}</span>
                      </div>
                      ...
                      <div className="flex space-x-2 pt-2">
                        ...
                        <Button size="sm" className="flex-1 bg-gradient-education text-white" asChild>
                          <a href={group.joinLink} target="_blank" rel="noopener noreferrer">
              ...
              {filteredGroups.length === 0 && (
                <Card className="text-center py-12">
                  <CardContent>
                    ...
                    <Button onClick={() => setShowCreateGroup(true)} className="bg-gradient-education text-white">
                      <Plus className="w-4 h-4 mr-2" />
                      Create New Group
                    </Button>
                  </CardContent>
            ...
            <TabsContent value="links" className="space-y-6">
              ...
              <div className="flex flex-wrap gap-2">
                {linkCategories.map((category) => (
                  <Button
                    key={category}
                    variant={selectedLinkCategory === category ? "default" : "outline"}
                    size="sm"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {filteredLinks.map((link) => (
                  <Card key={link.id} className={`group hover:shadow-lg transition-all duration-300 ${link.featured ? 'ring-2 ring-primary/20' : ''}`}>
                    <CardHeader className="pb-4">
                      <div className="flex items-start justify-between">
                    ...
                    <CardContent className="space-y-4">
                      <p className="text-muted-foreground text-sm line-clamp-2">{link.description}</p>
                      ...
                      <Button size="sm" className="w-full bg-gradient-education text-white" asChild>
              ...
              {filteredLinks.length === 0 && (
                <Card className="text-center py-12">
                  <CardContent>
                    ...
                    <h3 className="text-xl font-semibold mb-2">No group links found</h3>
                    <p className="text-muted-foreground">
                      Try adjusting your search or category filter to find relevant links.
                    </p>
                  </CardContent>
                </Card>
              )}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div className="text-center">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Treat all members with respect and maintain a positive learning environment.
                  </p>
                </div>
                ...
                <div className="text-center">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Help others by sharing your knowledge and learning resources.
                  </p>
                </div>
                ...
                <div className="text-center">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Keep discussions relevant to the group's purpose and academic goals.
                  </p>
                </div>
              </div>
            </CardContent>
