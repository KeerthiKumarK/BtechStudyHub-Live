...
const mockInternships: Internship[] = [
  {
    ...
    description:
      "Join our dynamic team to work on cutting-edge web applications using React, Node.js, and modern development practices.",
    requirements: [
      "Currently pursuing BTech/BE in Computer Science",
  ...
  },
  {
    ...
    description:
      "Work with real-world datasets to build machine learning models and create insightful data visualizations.",
    requirements: [
      "Knowledge of Python/R",
      "Basic understanding of statistics",
      "Curious about data analysis",
    ],
  ...
  },
  {
    ...
    description:
      "Develop native mobile applications for Android and iOS platforms using modern frameworks and best practices.",
    requirements: [
  ...
  },
  {
    ...
    description:
      "Create beautiful and responsive user interfaces for web applications using modern frontend technologies.",
    requirements: [
  ...
  },
  {
    ...
    description:
      "Learn and implement DevOps practices including CI/CD, containerization, and cloud infrastructure management.",
    requirements: [
  ...
  },
  {
    ...
    description:
      "Design user-centered interfaces and experiences for web and mobile applications using industry-standard tools.",
    requirements: [
        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            {filteredInternships.map((internship) => (
              <Card
                key={internship.id}
                className={`group hover:shadow-lg transition-all duration-300 ${internship.featured ? "ring-2 ring-primary/20" : ""}`}
              >
                <CardHeader className="pb-4">
                  <div className="flex items-start justify-between">
                    ...
                    >
                      <Heart
                        className={`w-5 h-5 ${internship.saved ? "fill-current" : ""}`}
                      />
                    </Button>
                  </div>
                </CardHeader>
                            ...
                            <>
                              ...
                              <div className="space-y-6">
                                ...
                                <div className="flex items-center justify-between pt-4 border-t border-border">
                                  ...
                                  >
                                    <a
                                      href={selectedInternship.applicationLink}
                                      target="_blank"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div className="text-center">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Focus on developing the technical skills mentioned in job
                    requirements.
                  </p>
                </div>
                ...
                <div className="text-center">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Build a portfolio of projects that demonstrate your
